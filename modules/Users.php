...
$languageStrings = array(
	'LBL_ADD_RECORD' => 'เพิ่มผู้ใช้งาน',

	//MyPreference Blocks
	'LBL_MY_PREFERENCES'  =>  'ตั้งค่าส่วนตัว',
	'LBL_MORE_INFORMATION'  =>  'รายละเอียดอื่นๆ',
	'LBL_USERLOGIN_ROLE'  =>  'ข้อมูลการเข้าสู่ระบบและสิทธิ์',
	'LBL_USER_IMAGE_INFORMATION' => 'รูปภาพผู้ใช้งาน',
	'LBL_CURRENCY_CONFIGURATION' =>  'การตั้่งค่าสกุลเงินและตัวเลข',
	'LBL_ADDRESS_INFORMATION' => 'ที่อยู่ผู้ใช้งาน',
	'LBL_USER_ADV_OPTIONS' => 'ตัวเลือกแบบละเอียด',
	'Asterisk Configuration'  =>  'ตั้งค่า Asterisk',
	'LBL_HOME_PAGE_COMPONENTS' => 'คอมโพเน้นหน้าหลัก',
	'LBL_TAG_CLOUD_DISPLAY' => 'แสดงแท็กคลาว',

	//MyPreference Fields
	'Role' => 'กฏ',
	'Admin' => 'ผู้ดูแลระบบ',
	'User Name' => 'ชื่อผู้ใช้',
	'Default Activity View' => 'ปฏิทินเริ่มต้น',
	'Default Lead View' => 'มุมมองเริ่มต้น',
	'Title' => 'ตำแหน่ง',
	'Office Phone' => 'เบอร์โทรสำนักงาน',
	'Department' => 'แผนก',
	'Reports To' => 'ขึ้นตรงกับ',
	'Yahoo id' => 'Yahoo id',
	'Home Phone' => 'โทรศัพท์บ้าน',
	'User Image' => 'อัฟโหลดรุปภาพ',
	...
	'LBL_SHOW' => 'แสดง',
	'LBL_HIDE' => 'ซ่อน',
	'LBL_HOME_PAGE_COMPO' => 'คอมโพแนนซ์หน้าหลัก',
	'LBL_LOGIN_HISTORY' => 'ประวัติการเข้าระบบ',
	'LBL_USERDETAIL_INFO' => 'รายละเอียดผู้ใช้งาน',
	'LBL_DELETE_GROUP' => 'ลบกลุ่ม',
	'LBL_DELETE_GROUPNAME' => 'Group to be Deleted',
	'LBL_TRANSFER_GROUP' => 'Transfer Ownership to: ',
	'LBL_DELETE_USER' => 'ผู้ใช้งานถูกลบแล้ว',
	...
	'Theme' =>  'ธีม',
	'Time Zone'  =>  'Time Zone',
	'Decimal Separator'  =>  'เครื่องหมายคั่นตัวเลข',
